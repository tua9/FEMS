        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4 py-6 bg-black/30 backdrop-blur-sm">
            ...
            <div className="relative w-full max-w-sm dashboard-card rounded-4xl shadow-2xl shadow-[#1E2B58]/20 p-8 animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="text-center mb-6">
                    ...
                    <h3 className="text-xl font-extrabold text-[#1E2B58] dark:text-white">{equipment.name}</h3>
                    <p className="text-sm font-semibold text-slate-400">ID: {equipment.id}</p>
                </div>

                <div className="bg-white rounded-2xl shadow-inner mx-auto w-48 h-48 flex items-center justify-center border border-slate-100">
