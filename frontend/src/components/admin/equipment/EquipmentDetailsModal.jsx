...
const EquipmentDetailsModal = ({ isOpen, equipment, onClose, onEdit, onReportDamage }) => {
 ...
 const getVirtualStatusDotClass = (vStatus) => {
 switch (vStatus) {
 ...
 <p className="text-[0.625rem] font-black text-[#1E2B58]/50 dark:text-white/40 uppercase tracking-widest mt-1">Equipment Code: {equipment.code || "#" + equipment._id.slice(-6).toUpperCase()}</p>
 </div>
