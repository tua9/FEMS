...
const DeviceDetailsModal: React.FC<DeviceDetailsModalProps> = ({ isOpen, device, onClose, onEdit }) => {
    ...
    return (
        createPortal(
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                ...
                {/* Modal Content */}
                <div className="relative w-full max-w-4xl bg-white/80 dark:bg-slate-800/80 backdrop-blur-2xl rounded-[48px] border border-white/50 dark:border-white/10 shadow-3xl overflow-hidden flex flex-col max-h-[92vh]">
                    ...
                    <div className="relative h-48 bg-slate-100 dark:bg-slate-900 overflow-hidden">
                        ...
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-white dark:from-slate-800 to-transparent"></div>

                        <button
                            onClick={onClose}
                            className="absolute top-8 right-8 p-3 bg-white/20 hover:bg-white/40 text-slate-700 dark:text-white rounded-full backdrop-blur-xl transition-all z-10 border border-white/20"
                        >
                            <span className="material-symbols-outlined">close</span>
                        </button>

                        <div className="absolute bottom-6 left-12 flex items-center gap-8">
                            <div className="w-24 h-24 rounded-3xl bg-white dark:bg-slate-700 p-2 shadow-2xl border border-white dark:border-slate-600">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-3">
                                    <span className={`px-4 py-1.5 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-sm ${getStatusColor(device.status)}`}>
                                        {device.status}
                                    </span>
                    ...
                    {/* Main Content Grid */}
                    <div className="p-12 overflow-y-auto no-scrollbar grid grid-cols-1 md:grid-cols-12 gap-10">
                        ...
                        <div className="md:col-span-8 space-y-10">
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-6">
                                    <div className="p-5 rounded-3xl bg-white/40 dark:bg-slate-900/30 border border-white dark:border-slate-700 shadow-sm">
                                    ...
                                    <div className="p-5 rounded-3xl bg-white/40 dark:bg-slate-900/30 border border-white dark:border-slate-700 shadow-sm">
                                        <p className="text-[10px] text-slate-400 font-bold uppercase mb-2">Quantity</p>
                                        <p className="text-sm font-black text-slate-800 dark:text-slate-200">{String(device.quantity).padStart(2, '0')} Units</p>
                                    </div>
                                    <div className="p-5 rounded-3xl bg-white/40 dark:bg-slate-900/30 border border-white dark:border-slate-700 shadow-sm">
                                        <p className="text-[10px] text-slate-400 font-bold uppercase mb-2">Warranty</p>
                                        <p className="text-sm font-black text-emerald-600 dark:text-emerald-400">Mar 2027</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="space-y-4">
                                    {[
                                        ...
                                        <div key={i} className="flex items-start gap-4 p-5 rounded-3xl bg-slate-50/50 dark:bg-slate-900/20 border border-slate-100 dark:border-slate-800 transition-all hover:bg-white dark:hover:bg-slate-900/40">
                                            <div className="w-10 h-10 rounded-2xl bg-white dark:bg-slate-800 border border-slate-100 dark:border-slate-700 flex items-center justify-center text-[#1A2B56] dark:text-blue-400 shadow-sm">
                        ...
                        <div className="md:col-span-4 space-y-8">
                            <div className="p-8 rounded-[40px] bg-[#1A2B56] dark:bg-slate-900 text-white shadow-2xl relative overflow-hidden group">
                                ...
                                <div className="space-y-4 relative z-10">
                                    <button
                                        ...
                                        className="w-full flex items-center gap-4 p-4 bg-white/10 hover:bg-white/20 rounded-2xl transition-all border border-white/10 font-bold text-sm"
                                    >
                                        <span className="material-symbols-outlined">edit_square</span>
                                        Edit Details
                                    </button>
                                    <button className="w-full flex items-center gap-4 p-4 bg-red-500/80 hover:bg-red-500 rounded-2xl transition-all font-bold text-sm shadow-xl shadow-red-900/20">
                            ...
                            <div className="p-8 rounded-[40px] border border-slate-200 dark:border-slate-700 border-dashed text-center">
                                ...
                                <p className="text-sm font-black text-slate-700 dark:text-slate-300 tracking-tight">March 12, 2024</p>
                            </div>
                        </div>
                    </div>
