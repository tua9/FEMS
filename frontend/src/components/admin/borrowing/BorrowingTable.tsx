                                            ...
                                            {record.status === 'Overdue' && (
                                                <div className="flex gap-1.5">
                                                    <button
                                                        ...
                                                        className="px-2.5 py-1 bg-red-50 text-red-600 hover:bg-red-600 hover:text-white rounded-lg text-xs font-bold transition-colors border border-red-100 flex items-center gap-1 whitespace-nowrap"
                                                    >
