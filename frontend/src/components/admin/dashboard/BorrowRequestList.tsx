...
import type { RecentBorrowRequest } from '../../../types/admin.types';
import { formatDistanceToNow } from 'date-fns';

interface BorrowRequestListProps {
    requests: RecentBorrowRequest[];
    efficiencyRate: number;
    onViewAll?: () => void;
    onItemClick?: (request: RecentBorrowRequest) => void;
}

const BorrowRequestList: React.FC<BorrowRequestListProps> = ({ requests, efficiencyRate, onViewAll, onItemClick }) => {
    return (
