...
const DeviceHealthChart: React.FC<DeviceHealthChartProps> = ({
    ...
    return (
        <div>
            <p className="text-[11px] font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-6">Device Health Status</p>
            <div className="relative flex items-center justify-center py-2">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-2xl font-black text-[#1A2B56] dark:text-white leading-tight">{healthyPercentage}%</span>
                    <span className="text-[8px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest leading-tight">Healthy</span>
                </div>
            </div>
