...
const wrapperVariants = {
    hidden:  { y: -8 },
    visible: { y: 0, transition: { duration: 0.2, ease: [0.16, 1, 0.3, 1] as [number, number, number, number] } },
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left transition-all ${
                                                    isActive ? 'bg-white/40 dark:bg-white/8' : 'hover:bg-white/30 dark:hover:bg-white/6'
                                                }`}
                                            >
