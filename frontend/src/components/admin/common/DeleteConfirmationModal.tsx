...
const DeleteConfirmationModal: React.FC<DeleteConfirmationModalProps> = ({
    ...
    return createPortal(
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
            ...
            {/* Modal Content */}
            <div className="relative w-full max-w-md bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-[32px] border border-white/50 dark:border-white/10 shadow-2xl overflow-hidden p-8 flex flex-col items-center text-center">
