...
function UserBubble({ text }) {
 ...
 >
 <div className="max-w-[78%] rounded-2xl rounded-br-sm bg-indigo-600 px-4 py-2.5 text-sm text-white shadow-sm">
 {text}
 </div>
 </motion.div>
 );
...
function WelcomeScreen({ onSelect }) {
 ...
 className="flex h-14 w-14 items-center justify-center rounded-2xl bg-indigo-600 shadow-lg shadow-indigo-200"
 >
 ...
 className="flex w-full items-center gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 text-left transition-all hover:border-indigo-200 hover:bg-indigo-50/50 hover:shadow-sm"
 >
...
function ChatBox() {
 ...
 className="flex h-14 w-14 items-center justify-center rounded-full bg-indigo-600 text-white shadow-xl shadow-indigo-200 transition-transform hover:scale-105 active:scale-95 hover:bg-indigo-700"
 >
 ...
 className="fixed bottom-6 right-6 z-50 flex h-[600px] w-[380px] flex-col overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 shadow-2xl shadow-slate-300/60"
 >
 {/* ── Header ── */}
 ...
 <div className="pointer-events-none absolute top-0 left-0 right-0 z-10 h-6 bg-linear-to-b from-slate-50 to-transparent" />
 ...
 <div className="pointer-events-none absolute bottom-0 left-0 right-0 z-10 h-6 bg-linear-to-t from-slate-50 to-transparent" />
 </div>
 ...
 className="flex-1 bg-transparent py-1 text-sm text-slate-700 placeholder:text-slate-400 outline-none"
 />
 <button
 disabled={!message.trim() || isTyping}
 onClick={() => handleSend()}
 className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-indigo-600 text-white transition-all hover:bg-indigo-700 hover:scale-105 active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:scale-100"
 >
