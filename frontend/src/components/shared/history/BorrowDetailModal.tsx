...
import BorrowCancelModal from '../../student/history/BorrowCancelModal';
...
export const BorrowDetailModal: React.FC<BorrowDetailModalProps> = ({ item: b, initialMode = 'view', onClose, onBorrowAgain }) => {
