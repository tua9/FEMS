...
const AssetCard: React.FC<Props> = ({ asset, onClick }) => {
  ...
  return (
    ...
    >
      {/* Icon box */}
      <div className="w-12 h-12 bg-slate-50 dark:bg-slate-700 rounded-2xl flex items-center justify-center text-slate-400 mb-4 group-hover:bg-[#232F58] group-hover:text-white transition-colors duration-200">
      ...
      <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mb-8">SN: {asset.serial}</p>
