...
import {
  Asset, AssetCategory, AssetStatus, getAssetStatusStyle,
...
const AddEquipmentModal: React.FC<Props> = ({ onClose, onAdd }) => {
  const [name,         setName]         = useState('');
  const [serial,       setSerial]       = useState('');
  const [category,     setCategory]     = useState<Exclude<AssetCategory, 'All Assets'>>('Computing');
