...
import { Asset, AssetCategory, AssetStatus, getAssetStatusStyle } from '@/data/technician/mockEquipment';
import {
...
const CATEGORIES: Exclude<AssetCategory, 'All Assets'>[] = [
  'Computing', 'AV Display', 'Networking', 'Peripherals', 'Other',
];

const STATUSES: AssetStatus[] = ['Operational', 'Maintenance', 'Faulty', 'Offline'];

const ICON_MAP: Record<Exclude<AssetCategory, 'All Assets'>, string> = {
...
const AssetEditModal: React.FC<Props> = ({ asset, onClose, onSave }) => {
  ...
  const handleImageChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (ev) => { set('imageUrl', ev.target?.result as string); setImageError(''); };
    reader.readAsDataURL(file);
  };

  const handleCategoryChange = (cat: Exclude<AssetCategory, 'All Assets'>) => {
