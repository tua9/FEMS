...
const TechnicianFooter: React.FC = () => {
  return (
    <footer className="py-12 border-t border-white/20 dark:border-white/5">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center gap-6">
        ...
        <p className="text-[9px] font-bold text-slate-500 dark:text-slate-600 tracking-[0.3em] uppercase text-center">
