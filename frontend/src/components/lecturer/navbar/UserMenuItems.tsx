      ...
      {menuItems.map((item: MenuItem) => {
        ...
        return (
          <button
            ...
            className={`group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left transition-all ${isActive
          ...
          >
            {/* Icon */}
            <div
              className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-xl transition-all ${isActive
                  ? `${item.activeBg}`
                  : `${item.iconBg} group-hover:scale-105`
                }`}
            >
              <span
                className={`material-symbols-rounded text-[16px] ${isActive ? "text-white" : item.iconColor
                  }`}
              >
                {item.icon}
              </span>
            ...
            <div className="min-w-0 flex-1">
              <p
                className={`text-[0.8125rem] leading-tight font-bold ${isActive
