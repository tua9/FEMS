...
export function getStatCards(days) {
...
export const STAT_CARDS= getStatCards(30);

// ── Ticket trend chart data ───────────────────────────────────────────────────
export function getTrendPoints(days) {
 if (days === 7) {
 return [
...
export const ALL_PERFORMERS_BASE= [
...
export function getAllPerformers(days) {
 const scale = days === 7 ? 0.22 : days === 30 ? 1 : days === 90 ? 2.8 : 4.5;
...
export function getTopPerformers(days) {
 return getAllPerformers(days).slice(0, 3);
}

export const TOP_PERFORMERS= getTopPerformers(30);

// ── Facility health rows ──────────────────────────────────────────────────────
export function getFacilityRows(days) {
...
export const FACILITY_ROWS= getFacilityRows(30);

// ── Helpers ───────────────────────────────────────────────────────────────────
export function getCriticalityStyle(c) {
 const map= {
...
export function getTrendIcon(t) {
 const map= {
