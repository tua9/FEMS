...
export type NotificationAction = 
  | { type: "modal"; modalType: "borrow" | "report"; id: string }
  | { type: "navigate"; to: string; state?: unknown }
  | { type: "none" };

export const getNotificationAction = (notification: Notification): NotificationAction => {
