...
import { BorrowHistoryTable, type BorrowStatus } from '../../components/shared/history/BorrowHistoryTable';
...
import type { ReportHistoryItem } from '@/components/shared/history/ReportHistoryTable';
