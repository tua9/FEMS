...
export const TECH_EQUIPMENT_SUMMARY= MOCK_EQUIPMENT.map(eq => {
...
export const TECH_REPORT_SUMMARY= MOCK_REPORTS.map(rep => {
...
export const BUILDING_HEALTH= MOCK_BUILDINGS.map(b => {
