...
export const MOCK_TASKS: MockTask[] = [
  {
    id: 'REP-7742',
    title: 'Epson Laser Projector',
    description: 'Block A, Room 402',
    category: 'Safety',
    displayCategory: 'AV Device',
    imageUrl: IMG.projector,
    priority: 'High',
    status: 'fixed',
    equipment: 'Epson Laser Projector',
    issue: 'Projector not displaying image / intermittent shutdown.',
  ...
  {
    id: 'REP-7810',
    title: 'Central AC Unit #12',
    description: 'Main Library, Level 2',
    category: 'Maintenance',
    displayCategory: 'HVAC',
    imageUrl: IMG.ac,
    priority: 'Medium',
    status: 'pending',
    equipment: 'Central AC Unit #12',
    issue: 'AC not cooling; unusual noise reported.',
  ...
  },
  {
    ...
    description: 'CS Lab 102',
    category: 'Electrical',
    displayCategory: 'IT Device',
    imageUrl: IMG.computer,
    priority: 'Low',
    status: 'pending',
    equipment: 'Dell Precision Tower',
    issue: 'Random restarts and cannot boot reliably.',
  ...
  {
    id: 'REP-7955',
    title: 'Smart Whiteboard Panel',
    description: 'Block B, Room 201',
    category: 'Safety',
    displayCategory: 'AV Device',
    imageUrl: IMG.whiteboard,
    priority: 'High',
    status: 'pending',
    equipment: 'Smart Whiteboard Panel',
    issue: 'Touch input not responding across part of the screen.',
  ...
  {
    id: 'REP-8012',
    title: 'Ceiling Fan Unit #5',
    description: 'Cafeteria, Level 1',
    category: 'Electrical',
    displayCategory: 'Electrical',
    imageUrl: IMG.fan,
    priority: 'Medium',
    status: 'pending',
    equipment: 'Ceiling Fan Unit #5',
    issue: 'Fan wobbling and making loud scraping noise.',
  ...
  {
    id: 'REP-8034',
    title: 'Water Pump Room B',
    description: 'Block B, Basement',
    category: 'Plumbing',
    ...
    issue: 'Low water pressure; pump intermittently failing.',
  ...
  },
  {
    ...
    description: 'Admin Office, Level 3',
    category: 'Electrical',
    displayCategory: 'IT Device',
    ...
    issue: 'Paper jams repeatedly on tray 2.',
  ...
  },
  {
    ...
    priority: 'Medium',
    status: 'pending',
    equipment: 'HVAC Ducting',
    issue: 'Airflow reduced; suspected duct blockage.',
  ...
  },
  {
    ...
    description: 'Block C, Stairwell',
    category: 'Safety',
    displayCategory: 'Safety',
    imageUrl: IMG.exitlight,
    priority: 'Urgent',
    status: 'pending',
    equipment: 'Emergency Exit Light',
    issue: 'Exit light not illuminating during power test.',
  ...
  },
  {
    ...
    status: 'pending',
    equipment: 'Door Lock',
    issue: 'Door lock jammed and cannot be secured.',
  ...
  {
    id: 'REP-8267',
    title: 'Network Switch Cabinet',
    description: 'Server Room, Level 1',
    category: 'Electrical',
    displayCategory: 'IT Device',
    ...
    issue: 'Intermittent network outages; switch ports flapping.',
  ...
  {
    id: 'REP-8310',
    title: 'Projector Screen Motor',
    description: 'Lecture Hall A',
    category: 'Safety',
    displayCategory: 'AV Device',
    imageUrl: IMG.screen,
    priority: 'Medium',
    ...
    issue: 'Screen motor stuck; cannot retract fully.',
