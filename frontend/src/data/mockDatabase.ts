...
export const MOCK_EQUIPMENT: Equipment[] = [
  { _id: 'e1',  name: 'MacBook Pro M2',        category: 'laptop',    available: true,  status: 'good',        room_id: 'r2',  borrowed_by: null, code: 'FPT-LAP-082', createdAt: '2023-03-15T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e2',  name: '4K Laser Projector',    category: 'projector', available: true,  status: 'maintenance', room_id: 'r4',  borrowed_by: null, code: 'FPT-PJ-014',  createdAt: '2021-07-08T00:00:00Z', updatedAt: '2024-10-15T00:00:00Z' },
  ...
  { _id: 'e4',  name: 'UltraWide Monitor',     category: 'monitor',   available: true,  status: 'good',        room_id: 'r3',  borrowed_by: null, code: 'FPT-MN-033',  createdAt: '2022-11-20T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e5',  name: 'Sony A7 IV Camera',     category: 'camera',    available: true,  status: 'good',        room_id: 'r9',  borrowed_by: null, code: 'FPT-CAM-011', createdAt: '2023-04-10T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e6',  name: 'Focusrite Interface',   category: 'audio',     available: true,  status: 'good',        room_id: 'r10', borrowed_by: null, code: 'FPT-AUD-007', createdAt: '2023-02-20T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e7',  name: 'Dell XPS 15',           category: 'laptop',    available: false, status: 'maintenance', room_id: null,  borrowed_by: 'u2', code: 'FPT-LAP-097', createdAt: '2023-07-21T00:00:00Z', updatedAt: '2024-10-18T00:00:00Z' },
  { _id: 'e8',  name: 'Epson Smart Projector', category: 'projector', available: true,  status: 'good',        room_id: 'r7',  borrowed_by: null, code: 'FPT-PJ-022',  createdAt: '2022-05-10T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e9',  name: 'HP LaserJet Enterprise',category: 'printer',   available: true,  status: 'good',        room_id: 'r1',  borrowed_by: null, code: 'FPT-PR-002',  createdAt: '2022-06-30T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e10', name: 'Cisco Catalyst Switch', category: 'network',   available: true,  status: 'good',        room_id: 'r11', borrowed_by: null, code: 'FPT-RO-007',  createdAt: '2019-08-22T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e11', name: 'Dell Precision Tower',  category: 'other',     available: false, status: 'broken',      room_id: null,  borrowed_by: null, code: 'FPT-PC-014',  createdAt: '2020-04-12T00:00:00Z', updatedAt: '2024-10-05T00:00:00Z' },
  { _id: 'e12', name: 'Smart Whiteboard',      category: 'other',     available: true,  status: 'good',        room_id: 'r6',  borrowed_by: null, code: 'FPT-OT-001',  createdAt: '2023-02-10T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
];
...
export const MOCK_BORROW_REQUESTS: BorrowRequest[] = [
  ...
  },
  {
    ...
    processed_by: null, borrow_date: '2024-10-28T08:00:00Z', return_date: '2024-10-30T17:00:00Z',
  ...
  },
  {
    ...
    type: 'equipment', status: 'pending',
    processed_by: null, borrow_date: '2024-10-27T09:00:00Z', return_date: '2024-10-27T12:00:00Z',
...
export const MOCK_REPORTS: Report[] = [
  {
    ...
    processed_by: 'u20', img: null, description: 'Projector lamp flickering, needs replacement.',
    createdAt: '2024-10-25T08:00:00Z', updatedAt: '2024-10-25T10:00:00Z',
  },
  {
    _id: 'rep2', user_id: 'u2', equipment_id: 'e11', room_id: null,
    type: 'equipment', status: 'pending',
    processed_by: null, img: null, description: 'GPU failure, cannot boot properly.',
