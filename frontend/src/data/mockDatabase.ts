...
import type {
  User, Building, Room, Equipment, BorrowRequest, Report,
} from './mockModels';
...
export const MOCK_EQUIPMENT: Equipment[] = [
  { _id: 'e1',  name: 'MacBook Pro M2',        category: 'laptop',    available: true,  status: 'good',        room_id: 'r2',  borrowed_by: null, qr_code: 'FPT-LAP-082', createdAt: '2023-03-15T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e2',  name: '4K Laser Projector',    category: 'projector', available: true,  status: 'maintenance', room_id: 'r4',  borrowed_by: null, qr_code: 'FPT-PJ-014',  createdAt: '2021-07-08T00:00:00Z', updatedAt: '2024-10-15T00:00:00Z' },
  { _id: 'e3',  name: 'iPad Air 5th Gen',      category: 'tablet',    available: false, status: 'good',        room_id: 'r5',  borrowed_by: 'u3', qr_code: 'FPT-TAB-055', createdAt: '2023-09-01T00:00:00Z', updatedAt: '2024-10-20T00:00:00Z' },
  { _id: 'e4',  name: 'UltraWide Monitor',     category: 'monitor',   available: true,  status: 'good',        room_id: 'r3',  borrowed_by: null, qr_code: 'FPT-MN-033',  createdAt: '2022-11-20T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e5',  name: 'Sony A7 IV Camera',     category: 'camera',    available: true,  status: 'good',        room_id: 'r9',  borrowed_by: null, qr_code: 'FPT-CAM-011', createdAt: '2023-04-10T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e6',  name: 'Focusrite Interface',   category: 'audio',     available: true,  status: 'good',        room_id: 'r10', borrowed_by: null, qr_code: 'FPT-AUD-007', createdAt: '2023-02-20T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e7',  name: 'Dell XPS 15',           category: 'laptop',    available: false, status: 'maintenance', room_id: null,  borrowed_by: 'u2', qr_code: 'FPT-LAP-097', createdAt: '2023-07-21T00:00:00Z', updatedAt: '2024-10-18T00:00:00Z' },
  { _id: 'e8',  name: 'Epson Smart Projector', category: 'projector', available: true,  status: 'good',        room_id: 'r7',  borrowed_by: null, qr_code: 'FPT-PJ-022',  createdAt: '2022-05-10T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e9',  name: 'HP LaserJet Enterprise',category: 'printer',   available: true,  status: 'good',        room_id: 'r1',  borrowed_by: null, qr_code: 'FPT-PR-002',  createdAt: '2022-06-30T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e10', name: 'Cisco Catalyst Switch', category: 'network',   available: true,  status: 'good',        room_id: 'r11', borrowed_by: null, qr_code: 'FPT-RO-007',  createdAt: '2019-08-22T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
  { _id: 'e11', name: 'Dell Precision Tower',  category: 'other',     available: false, status: 'broken',      room_id: null,  borrowed_by: null, qr_code: 'FPT-PC-014',  createdAt: '2020-04-12T00:00:00Z', updatedAt: '2024-10-05T00:00:00Z' },
  { _id: 'e12', name: 'Smart Whiteboard',      category: 'other',     available: true,  status: 'good',        room_id: 'r6',  borrowed_by: null, qr_code: 'FPT-OT-001',  createdAt: '2023-02-10T00:00:00Z', updatedAt: '2024-10-01T00:00:00Z' },
];
...
export const MOCK_BORROW_REQUESTS: BorrowRequest[] = [
  {
    _id: 'br1', user_id: 'u1', equipment_id: 'e1', room_id: null,
    type: 'equipment', status: 'returned',
    approved_by: 'u10', borrow_date: '2024-10-24T09:00:00Z', return_date: '2024-10-24T12:00:00Z',
    note: 'CS-405 Lab session', createdAt: '2024-10-23T10:00:00Z', updatedAt: '2024-10-24T12:05:00Z',
  },
  {
    _id: 'br2', user_id: 'u2', equipment_id: 'e7', room_id: null,
    type: 'equipment', status: 'approved',
    approved_by: 'u10', borrow_date: '2024-10-22T14:00:00Z', return_date: '2024-10-24T16:00:00Z',
    note: 'ENG-101 practical', createdAt: '2024-10-21T09:00:00Z', updatedAt: '2024-10-22T14:10:00Z',
  },
  {
    _id: 'br3', user_id: 'u3', equipment_id: 'e3', room_id: null,
    type: 'equipment', status: 'rejected',
    approved_by: 'u10', borrow_date: '2024-10-25T08:00:00Z', return_date: '2024-10-26T17:00:00Z',
    note: 'Photography assignment', createdAt: '2024-10-24T15:00:00Z', updatedAt: '2024-10-24T16:00:00Z',
  },
  {
    _id: 'br4', user_id: 'u1', equipment_id: 'e5', room_id: null,
    type: 'equipment', status: 'returned',
    approved_by: 'u11', borrow_date: '2024-10-15T09:00:00Z', return_date: '2024-10-15T17:00:00Z',
    note: 'Media project', createdAt: '2024-10-14T11:00:00Z', updatedAt: '2024-10-15T17:05:00Z',
  },
  {
    _id: 'br5', user_id: 'u4', equipment_id: 'e8', room_id: null,
    type: 'equipment', status: 'pending',
    approved_by: null, borrow_date: '2024-10-28T08:00:00Z', return_date: '2024-10-30T17:00:00Z',
    note: 'Seminar presentation', createdAt: '2024-10-25T09:00:00Z', updatedAt: '2024-10-25T09:00:00Z',
  },
  {
    _id: 'br6', user_id: 'u2', equipment_id: 'e1', room_id: null,
    type: 'equipment', status: 'pending',
    approved_by: null, borrow_date: '2024-10-27T09:00:00Z', return_date: '2024-10-27T12:00:00Z',
    note: 'Academic project', createdAt: '2024-10-25T13:00:00Z', updatedAt: '2024-10-25T13:00:00Z',
  },
  {
    _id: 'br7', user_id: 'u3', equipment_id: 'e4', room_id: null,
    type: 'equipment', status: 'returned',
    approved_by: 'u10', borrow_date: '2024-10-12T08:30:00Z', return_date: '2024-10-12T10:30:00Z',
...
export const MOCK_REPORTS: Report[] = [
  {
    _id: 'rep1', user_id: 'u1', equipment_id: null, room_id: 'r8',
    type: 'infrastructure', status: 'approved',
    approved_by: 'u20', img: null, description: 'Projector lamp flickering, needs replacement.',
    createdAt: '2024-10-25T08:00:00Z', updatedAt: '2024-10-25T10:00:00Z',
  },
  {
    _id: 'rep2', user_id: 'u2', equipment_id: 'e11', room_id: null,
    type: 'equipment', status: 'pending',
    approved_by: null, img: null, description: 'GPU failure, cannot boot properly.',
    createdAt: '2024-10-24T14:00:00Z', updatedAt: '2024-10-24T14:00:00Z',
  },
  {
    _id: 'rep3', user_id: 'u10', equipment_id: null, room_id: 'r6',
    type: 'infrastructure', status: 'pending',
    approved_by: null, img: null, description: 'HVAC not working in CS Lab 102.',
    createdAt: '2024-10-22T10:00:00Z', updatedAt: '2024-10-22T10:00:00Z',
  },
  {
    _id: 'rep4', user_id: 'u3', equipment_id: 'e2', room_id: null,
    type: 'equipment', status: 'rejected',
    approved_by: 'u20', img: null, description: 'HDMI port damaged on projector.',
    createdAt: '2024-10-20T09:00:00Z', updatedAt: '2024-10-20T11:00:00Z',
  },
  {
    _id: 'rep5', user_id: 'u1', equipment_id: null, room_id: 'r3',
    type: 'infrastructure', status: 'approved',
    approved_by: 'u20', img: null, description: 'Electrical issue: short circuit at Room 305.',
    createdAt: '2024-10-18T07:30:00Z', updatedAt: '2024-10-18T09:00:00Z',
  },
  {
    _id: 'rep6', user_id: 'u4', equipment_id: 'e12', room_id: null,
    type: 'equipment', status: 'approved',
    approved_by: 'u21', img: null, description: 'Smart whiteboard touch screen not responding.',
    createdAt: '2024-10-15T11:00:00Z', updatedAt: '2024-10-15T13:00:00Z',
  },
  {
    _id: 'rep7', user_id: 'u2', equipment_id: null, room_id: 'r11',
    type: 'infrastructure', status: 'approved',
    approved_by: 'u20', img: null, description: 'Network switch cabinet fan making loud noise.',
...
export const getUserById   = (id: string) => MOCK_USERS.find(u => u._id === id);
export const getBuildingById = (id: string) => MOCK_BUILDINGS.find(b => b._id === id);
export const getRoomById   = (id: string) => MOCK_ROOMS.find(r => r._id === id);
export const getEquipmentById = (id: string) => MOCK_EQUIPMENT.find(e => e._id === id);

/** Populate a BorrowRequest with related objects (like Mongoose .populate()) */
export function populateBorrowRequest(br: BorrowRequest): BorrowRequest {
  return {
    ...br,
    ...
    approver:  br.approved_by  ? getUserById(br.approved_by)       : undefined,
  };
}

/** Populate a Report with related objects */
export function populateReport(rep: Report): Report {
  return {
    ...rep,
    ...
    approver:  rep.approved_by  ? getUserById(rep.approved_by)       : undefined,
  };
}

/** Populate Equipment with room and borrower */
export function populateEquipment(eq: Equipment): Equipment {
  return {
    ...eq,
