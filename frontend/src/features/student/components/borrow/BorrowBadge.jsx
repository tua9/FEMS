...
const BorrowBadge = ({ status, req }) => {
  ...
  const approvedLabel = req?.handoverInfo?.submittedAt
  ...
  const cfg = {
    ...
    [BORROW_STATUS.RETURNING]: {
      ...
      cls: "bg-violet-50 text-violet-600 border-violet-200 dark:bg-violet-900/20 dark:text-violet-400 dark:border-violet-900/30",
    },
    ...
    [BORROW_STATUS.UNRETURNED]: {
      label: "Not returned",
      cls: "bg-red-100 text-red-700 border-red-300 dark:bg-red-900/40 dark:text-red-300 dark:border-red-800 animate-pulse",
    },
