...
import DamageReportTable from '../components/reports/DamageReportTable';
import Pagination from '@/features/shared/components/Pagination';
import ResolutionStats from '../components/reports/ResolutionStats';
import DamageReportDetailModal from '../components/reports/DamageReportDetailModal';
import TechnicianAssignmentModal from '../components/reports/TechnicianAssignmentModal';
...
const DamageReports = () => {
 ...
 const handleConfirmAssign = async (technician) => {
 ...
 const handleQuickResolve = async (report) => {
 try {
