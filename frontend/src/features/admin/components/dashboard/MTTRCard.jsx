  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col items-center text-center py-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl">
        ...
        <span className="text-xs text-slate-500 dark:text-slate-400 mt-1">avg hours / incident</span>
        {fixedCount > 0 && (
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between text-xs">
          ...
          <span className="font-bold text-slate-700 dark:text-slate-200">{fixedCount} incidents</span>
        </div>
        <div className="flex items-center justify-between text-xs">
          <span className="text-slate-500 dark:text-slate-400">Damage report rate</span>
