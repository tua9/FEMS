...
const EquipmentTable = ({ equipments, onOpenDetails, onOpenQRCode, onEdit, onDelete, onReportDamage, activeRequests = [] }) => {
 ...
 <table className="w-full text-left border-separate border-spacing-y-4 min-w-[1024px] table-fixed">
 <thead>
 ...
 <th className="px-6 pb-2 text-[11px] font-semibold uppercase tracking-[0.2em] opacity-80 hidden lg:table-cell">Model</th>
