...
const UserDetailModal = ({ isOpen, user, onClose, onEdit, onUpdate }) => {
 const [status, setStatus] = useState(user?.isActive !== false ? 'Active' : 'Inactive');
 ...
 await updateUser(user._id, { isActive: newIsActive });
