...
const StatusUpdate = ({ task, onUpdate }) => {
 ...
 { value: 'In Progress', icon: 'autorenew', color: 'text-purple-500 bg-purple-500/10 hover:bg-purple-500/20' },
 { value: 'Completed', icon: 'check_circle', color: 'text-green-500 bg-green-500/10 hover:bg-green-500/20' },
 ...
 status: selectedStatus !== task.status ? selectedStatus : task.status,
