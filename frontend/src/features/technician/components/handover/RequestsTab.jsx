...
import { MOCK_BORROW_REQUESTS } from '@/mocks/technician/mockHandover';
...
const DEFAULT_FILTERS= { departments: [], durations: [], statuses: [] };
...
const ActionModal = ({ request, action, onConfirm, onClose }) => {
...
// ── Single row ────────────────────────────────────────────────────────────────
const RequestRow = ({ req, onDetails, onApprove, onReject }) => (
...
const RequestsTab = () => {
 ...
 MOCK_BORROW_REQUESTS.map((r) => ({ ...r, status: 'Pending' }))
 );
