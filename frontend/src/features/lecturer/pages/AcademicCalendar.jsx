...
function getEventsForDate(date, filters) {
...
// ── Month View ────────────────────────────────────────────────────────────────
const MonthView = ({ viewDate, filters, onDayClick, onEventClick }) => {
...
// ── Week View ─────────────────────────────────────────────────────────────────
const WeekView = ({ viewDate, filters, onDayClick, onEventClick }) => {
...
// ── Day View ──────────────────────────────────────────────────────────────────
const DayView = ({ date, filters, onEventClick }) => {
 const events = getEventsForDate(date, filters);
 const isToday = isSameDay(date, TODAY);
...
// ── Event Detail Modal ────────────────────────────────────────────────────────
const EventModal = ({ event, onClose, onNavigateRoom }) => {
...
export const AcademicCalendar = () => {
 ...
 const [filters, setFilters] = useState({ myClasses: true, deptMeetings: true, labSessions: true });
