    ...
    >
      <div className="dashboard-card rounded-4xl p-8 w-full max-w-md shadow-2xl shadow-[#1E2B58]/20 relative animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex flex-col items-center text-center gap-4 mb-6">
          ...
          <div>
            <p className="text-[0.625rem] font-black uppercase tracking-widest text-[#1E2B58]/50 dark:text-white/40 mb-1">Confirm handover</p>
            <h3 className="text-xl font-black text-[#1E2B58] dark:text-white">Hand over equipment?</h3>
          </div>
        </div>
        ...
        <div className="bg-white/40 dark:bg-slate-800/40 rounded-[1.25rem] p-4 mb-6 space-y-2 text-sm">
          {[
            ...
            ['Handed to', getStudentName(request)],
            ['Note', request.note || '—'],
          ].map(([label, value]) => (
        ...
        <div className="mb-5">
          ...
          <p className="text-[10px] text-slate-400 mt-2 italic">* Take photos showing equipment condition at handover.</p>
        </div>
