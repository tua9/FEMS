...
const BorrowBadge = ({ status }) => {
  const cfg = {
    ...
    handed_over: { label: 'Đang mượn',   cls: 'bg-emerald-50 text-emerald-600 border-emerald-200 dark:bg-emerald-900/20 dark:text-emerald-400 dark:border-emerald-900/30' },
    returning:   { label: 'Chờ trả',     cls: 'bg-amber-50 text-amber-600 border-amber-200 dark:bg-amber-900/20 dark:text-amber-400 dark:border-amber-900/30' },
